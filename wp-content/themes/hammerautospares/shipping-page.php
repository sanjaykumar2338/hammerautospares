    ...
    <div class="container">
        ...
        <div class="fast-rw">
            <div class="row align-items-center">
                <div class="col-md-7">
                    <div class="fast_img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pngtree-fast-delivery-label-design-png-image_9153915-AGB4Rw6qoaiVwOK6.png" alt="Fast Delivery">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="fast_cnt">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="shp-left">
                    ...
                    <ul>
                        <li>
                            <strong>Support</strong> <a href="tel:+442034320393">+442034320393</a>
                        </li>
                        <li>
