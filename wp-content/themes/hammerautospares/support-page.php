    ...
    <div class="container">
        ...
        <div class="sprt-rw">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="sprt-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/car.jpg" alt="Car Image">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="item">
                            <div class="review_bx">
                                ...
                                <div class="review_text">
                                    <p>Hammer Auto Spares provided excellent service and quality parts for my classic car restoration project.</p>
                                </div>
                                <div class="name">
                                    <img src="<?php echo get_template_directory_uri(); ?>/images/photo-1498595718608-0981b1355981.jpg" alt="John Doe">
                                    <h2>John Doe</h2>
                                </div>
                            </div>
                        </div>
